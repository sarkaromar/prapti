...
<div class="featured">
    ...
    <div class="container">
        <div class="one_half txt-center"> 
            <img src="<?=base_url()?>assets/images/sliders/master/3.jpg" alt="" width="100%" />
        </div>
        <div class="one_half last">
            <h2><?=$title?></h2>
            <p class="txt-left">Prapti Trade internationai a poprietcrship construction of Md. Obaydul
